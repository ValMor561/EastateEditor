...
BEGIN
    RETURN QUERY
		SELECT contr."ContractID", contr."DateOfContract", contr."DateOfPayment", contr."CostOfObject", contr."ContractType", empl."Surname", empl."Name", pco."Surname", pco."Name", pcc."Surname", pcc."Name" 
        FROM "Contract" contr
		...
		ORDER BY contr."ContractID" OFFSET (page_num - 1) * 59 LIMIT 59;
END;
$$ LANGUAGE plpgsql;