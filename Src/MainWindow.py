...
class MainWindow:
    ...
    def NotebookWindow(self):
        ...
        function = {'Объекты недвижимости' : ['get_real_eastate', 'delete_eastate', 'update_real_estate_object', 'add_real_estate_object'], 'Данные клиентов' : ['get_passport_client', 'delete_client', 'update_passport', 'add_passport'], 'Контракты' : ['get_contract','delete_contract', 'update_contract', 'add_contract'], 'Сотрудники': ['get_employee','delete_employee', 'update_employee', 'add_employee']}
