...
class MainWindow:
    ...
    def NotebookWindow(self):
        ...
        entities = {'Объекты недвижимости' : ["hidden",'Адресс', 'Площадь', 'Тип объекта', 'Район', 'Город', 'Фамилия владельца', 'Имя владельца'], 'Данные клиентов' : ["hidden", 'Фамилия', 'Имя', 'Номер паспорта','Код отделения', 'Дата рождения', 'Город', 'Возраст', 'Семейное положение'], 'Сотрудники': ["hidden", 'Фамилия', 'Имя', 'Имя компании']}
